...
class CoordinateDescentSolver:
    ...
    def solve_all_problems(self, max_iter=1000, tol=1e-6):
        ...
        Args:
            ...
            tol (float): Tolerância para convergência
        """
        print("Iniciando resolução de todos os problemas com Descida por Coordenadas...")
        print("=" * 70)
    ...
    def generate_latex_table(self, filename='PROJETO/latex_solution/resultados_coordinate_descent.tex'):
        """
